INSERT INTO cat_street (street_code, street_name) VALUES
(1, 'улица Марашала Новикова'),
(2, 'Ленинградский проспект'),
(3, 'улица Героев Панфиловцев'),
(4, 'улица Свободы'),
(5, 'проспект Дорохова');
...
INSERT INTO passport_office (p_office_id, p_office_area_id, p_office_name) VALUES
